...
<body>
	<form:form modelAttribute="orden" action="../ModificarOrden/${orden.id}" method="post">
		<form:label path="Patente">Patente:</form:label>
		<form:input path="patente" maxlength="50" />
		<br>
		<form:label path="FechaIngreso">Fecha Ingreso:</form:label>
		<form:input path="fechaIngreso" maxlength="50" />
		<br>
